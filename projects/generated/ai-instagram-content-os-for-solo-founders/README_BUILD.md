# README_BUILD: Ai Instagram Content Os For Solo Founders

Generated locally by EMOVEL Prompt Studio v1.4 on 2026-06-21T16:54:33.979Z.

## Purpose

This folder contains local production planning files for Ai Instagram Content Os For Solo Founders. Use `gpt-pilot-prompt.md` as the builder prompt for GPT-Pilot or Pythagora.

## How To Use With GPT-Pilot / Pythagora

1. Open GPT-Pilot or Pythagora in its own workspace.
2. Start a new app project.
3. Paste the full contents of `projects/generated/ai-instagram-content-os-for-solo-founders/gpt-pilot-prompt.md` as the project brief.
