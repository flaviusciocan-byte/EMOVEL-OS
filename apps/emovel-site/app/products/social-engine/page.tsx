...
export const metadata: Metadata = {
  title: "Social Engine",
  description:
    "Systematic content and growth for operator brands. Content calendar, post frameworks, and growth system — without the hamster wheel.",
};
    ...
    <section className="bg-white pt-36 pb-28 md:pt-44 md:pb-36 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <FadeIn delay={80}>
          ...
          >
            Systematic content and growth for operator brands.
          </h1>
        </FadeIn>
        <FadeIn delay={160}>
          <p className="text-xl text-gray-500 leading-relaxed mb-10 max-w-xl">
            A structured content OS for building an audience as a founder or operator.
            Content calendar, post frameworks, and growth system — without the hamster wheel.
          </p>
        </FadeIn>
